...
DISCORD_TOKEN = os.getenv("DISCORD_BOT_TOKEN", "MTM3NjU0ODM0NzA5NTI4NTg3Mg.GbgBe_.UCY58Ubs5NSlp-mNT9wVQwW-wPlvU4lGeNCKa8")
...
VERIFICATION_CHANNEL_ID = 1383490270850584707  # Канал верификации
VERIFIED_ROLE_ID = 1375794448650342521  # Роль после верификации

# Raid Protection Configuration
MAX_JOINS_PER_MINUTE = 10  # Максимум входов в минуту для рейд-защиты
MAX_MESSAGES_PER_MINUTE = 20  # Максимум сообщений от одного пользователя
MAX_ACCOUNTS_PER_IP = 1  # Максимум аккаунтов с одного IP

# Security Log Channel (будет найден автоматически по названию)
SECURITY_LOG_CHANNEL = None  # Будет найден канал с "security", "безопасность", "logs" в названии

# Protected Roles (не могут быть забанены системой защиты)
PROTECTED_ROLES = [
    1375794448650342521,  # Основная роль
    # Добавьте другие важные роли здесь
]
